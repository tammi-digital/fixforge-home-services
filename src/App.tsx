...
function App() {
  ...
  return (
    <div className="site-shell">
      ...
      <footer><div className="container footer-inner"><a className="brand" href="#home"><span className="brand-mark">✦</span><span>FIX<span>FORGE</span><small>HOME SERVICES</small></span></a><p>Built to Fix. Trusted to Finish.<br />Pueblo, Colorado</p><a className="phone-link" href={phoneLink}>{phone} ↗</a></div><div className="container footer-bottom"><span>© 2026 FixForge Home Services</span><a href="mailto:chris666213@gmail.com">chris666213@gmail.com</a></div></footer>
